...
describe('article kind labels', () => {
  it('maps kinds to badge classes and labels', () => {
    ...
    expect(articleKindBadgeClass('software')).toBe('project-card__badge--app')
    ...
    expect(articleKindLabel('software')).toBe('Desktop app')
    ...
    expect(articleKindShortLabel('software')).toBe('App')
